...
import com.yihui.huioj.judge.JudgeService;
import com.yihui.huioj.judge.codesandbox.model.JudgeInfo;
import com.yihui.huioj.model.dto.question.*;
...
public class QuestionController {
    ...
    public BaseResponse<JudgeInfo> runCode(@RequestBody QuestionSubmitAddRequest questionSubmitAddRequest){
        if (questionSubmitAddRequest == null || questionSubmitAddRequest.getQuestionId() <= 0) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
        JudgeInfo judgeInfo = judgeService.runCode(questionSubmitAddRequest);
