...
import static com.yihui.huioj.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
     ...
     * 盐值，混淆密码
     */
    public static final String SALT = "yihui";
    ...
    public LoginUserVO getLoginUserVO(User user) {
        ...
        LoginUserVO loginUserVO = LoginUserVO.objToVo(user);
